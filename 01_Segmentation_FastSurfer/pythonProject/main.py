...
input=/.../FastSurfer/orig.mgz

# Define where you stored the output
outputDir=/.../FastSurfer/Output_test

# Define where your local installation of FastSurfer can be found
export FASTSURFER_HOME=/.../FastSurfer/pythonProject/fastsurfer/
...
for i in list:
    i = '001' # test code
    path = '/.../subjects-5.3.0-STORAGE-freesurfer'
    file_1 = i + '/'  # 001/
    file_2 = i + '_TP2/'  # 001_TP2/
    rest = 'mri/orig.mgz'
    input = os.path.join(path, file_1, file_2, rest)
    outputDir= '/.../FastSurfer/Output1/'
    env = 'export FASTSURFER_HOME=/.../FastSurfer/pythonProject/fastsurfer'
